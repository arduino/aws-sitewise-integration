...
func (_m *API) GetTimeSeriesByThing(ctx context.Context, thingID string, from time.Time, to time.Time, interval int64) (*iot.ArduinoSeriesBatch, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Time, time.Time, int64) (*iot.ArduinoSeriesBatch, bool, error)); ok {
		return rf(ctx, thingID, from, to, interval)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Time, time.Time, int64) *iot.ArduinoSeriesBatch); ok {
...
func (_m *API) GetTimeSeriesSampling(ctx context.Context, propertiesToImport []string, from time.Time, to time.Time, interval int32) (*iot.ArduinoSeriesBatchSampled, bool, error) {
